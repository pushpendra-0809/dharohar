...
func _trigger_vihara_transition() -> void:
	...
	var arrival_seq: Array = [
		{"speaker": "Resident Monk", "text": "You have entered the Nalanda Vihara living quarters."},
		{"speaker": "Resident Monk", "text": "Here, monks and scholars reside, meditate, and engage in profound contemplation."}
	]
